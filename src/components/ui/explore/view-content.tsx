...
const ViewContent = () => {
  ...
  const getCategoryInfo = (category: ContentType) => {
    switch (category) {
      case 'video':
        return { icon: <FaFilm className="mr-2 text-[#aedd2b]" />, text: 'Video' };
      case 'podcast':
        return { icon: <FaMicrophone className="mr-2 text-[#aedd2b]" />, text: 'Podcast' };
      case 'documentary':
        return { icon: <FaBook className="mr-2 text-[#aedd2b]" />, text: 'Documental' };
      default:
